...
class QMixer(nn.Module):
    def __init__(self, decomposer, args):
        ...
        if self.state_timestep_number:
            mixing_input_dim = self.entity_embed_dim + timestep_state_dim + args.task_repre_dim
            entity_mixing_input_dim = self.entity_embed_dim + self.entity_embed_dim + timestep_state_dim + args.task_repre_dim
        else:
