    ...
    def run(self, test_mode=False, pretrain_phase=False, evaluate_mode=False):
        ...
        while not terminated:
            ...
            if pretrain_phase:
                ...
                actions = self.mac.select_actions(self.batch, t_ep=self.t, t_env=0, test_mode=False)
            else:
        ...
        if not pretrain_phase:
            ...
            if not evaluate_mode and test_mode and len(self.test_returns) == self.args.test_nepisode:
                self._log(cur_returns, cur_stats, log_prefix)            
            elif evaluate_mode and test_mode and len(self.test_returns) == self.args.test_nepisode:
                print(f"========== test result ==========")
